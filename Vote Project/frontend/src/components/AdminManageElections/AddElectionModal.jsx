        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-purple-100 border border-purple-200 rounded-lg p-6 w-[90%] max-w-2xl relative shadow-xl overflow-y-auto max-h-[90vh]">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {/* รายละเอียด (Rich Text) */}
                    {/* version ติดตั้ง libary */}
                    {/* <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                            รายละเอียด
                        </label>
                        <div className="border border-purple-300 rounded overflow-hidden bg-white">
                            <ReactQuill
                                theme="snow"
                                value={form.description}
                                onChange={handleDescChange}
                                placeholder="กรอกรายละเอียด (รองรับตัวหนา ตัวเอียง จุด/เลขย่อหน้า ลิงก์ ฯลฯ)"
                                modules={{
                                    toolbar: [
                                        [{ header: [1, 2, false] }],
